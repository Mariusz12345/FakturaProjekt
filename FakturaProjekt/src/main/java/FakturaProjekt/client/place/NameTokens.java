...
public class NameTokens {
	...
	public static final String wypis = "wypis";

	public static final String event = "event";

	public static final String presenter2 = "presenter2";
	...
	public static String getFaktura() {
		return faktura;
	}
	...
	public static String getPozycja() {
		return pozycja;
	}
	...
	public static String getPresenter2() {
		return presenter2;
	}
	...
	public static String getWypis() {
		return wypis;
	}

	public static String getPrzeslij() {
		return przeslij;
	}
